...
(function(window, document, undefined) {
  ...
  function getDefaultHTML() {
    var captionHTML = '<div class="sogou-passport-caption tc re">搜狗账号登录' +
    ...
    var trdHTML = '<div id="sogou-passport-3rd" class="re sogou-passport-3rd">' +
      ...
      '<div class="sogou-passport-3rd-icons tc">' +
      '<a href="#" data-provider="qq" class="ib sogou-passport-icon sogou-passport-icon-3rdqq" title="QQ登录"></a>' +
      '<a href="#" data-provider="sina" class="ib sogou-passport-icon sogou-passport-icon-3rdsina" title="微博登录"></a>' +
      '<a href="#" data-provider="renren" class="ib sogou-passport-icon sogou-passport-icon-3rdrenren" title="人人登录"></a>' +
      '</div>' +
      '</div>';
  ...
  PassportCanvas.prototype = {
    ...
    initEvent: function() {
      ...
      UTILS.dom.bindEvent($submit, 'click', function(e) {
        var dom = UTILS.dom.eventTarget(e);
        UTILS.dom.preventDefault(e);
        console.debug('Passport form clicking');
        self.doPost();
        return false;
      });
